...
import re
from kg.graph_utils import NodeTagType
...
class Retriever:
    def __init__(self, embedding_dict, store_dict, verbose=False):
        if "model" in embedding_dict and "tokenizer" in embedding_dict and "model_dim" in embedding_dict:
            ...
            self.model_dim = embedding_dict["dim"]
        else:
    ...
    def retrieve(self, query):
        ...
        retrieve_obj_list = self.store.range_query(q_embeddings)
