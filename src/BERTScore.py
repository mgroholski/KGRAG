...
def calculate_bert_score(predictions, ground_truths, lang="en"):
    ...
    # Skip empty strings to avoid errors
...
if __name__ == "__main__":
    ...
    ground_truths = ["Paris is the main city in France"]

    result = calculate_bert_score(predictions, ground_truths)
    print("🔍 BERTScore Results:", result)
